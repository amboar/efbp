...
public class CapturedCyclicIteratorTest {
    @Test
    public void zeroElements() {
        final Iterator<Object> cycle =
            new CapturedCyclicIterator<>(Collections.emptySet().iterator());
    ...
    public void oneElementOnce() {
        ...
        final Iterator<Object> cycle =
            new CapturedCyclicIterator<>(Collections.singleton(o).iterator());
    ...
    public void twoElementsOnce() {
        ...
        c.add(o2);
        final Iterator<Object> cycle = new CapturedCyclicIterator<>(c.iterator());
