...
public interface Inject<E>
{
     ...
     * connected Outbound queues. This method is different to
     * {@see #egress(final Packet<E> packet)} in that egress will not check for
     ...
     * injected packet is checked for any {@link Command}s that may be
     * relevent, the enqueued on connected Outbound queues. In the same vein as
     * {@see #inject(final Packet<E> packet), this method will check all
     * packets in the collection for {@link Command}s applicable to the
     * instance.
     *
     * @param packets
     *          The packet instance to inject into the network.
