...
public interface Connection<T> extends Inbound<T>, Outbound<T>
{
     ...
     * context, this is used to drain Inbound queues via iteration, matching
     * the intuitive idea of consuming elements from the queue without
     * substantial boilerplate code.
     */
